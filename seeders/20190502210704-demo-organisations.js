...
module.exports = {
  up: (queryInterface, Sequelize) => {
    const seedOrganisations = queryInterface.bulkInsert(
      'organisations',
      [
        {
          ...
          type: 'ngo',
          description:
            '“Nature conservation through collaboration with and development of the local population.” That is the mission of Masarang, our foundation in Indonesia, founded in 2001 by Dr. Eng. Willie Smits.\n' +
    ...
    return Promise.all([seedOrganisations])
  },
